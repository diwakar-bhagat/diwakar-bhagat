...
(function() {
 const categories = [
   ...
   { title: 'Data & Cloud', color: '#fb7185', items: [
 ...
 return (
   <div style={{
     ...
     fontFamily: 'Inter', padding: '24px 40px', gap: 14,
     ...
     <div style={{ display:'flex', fontSize:10, fontWeight:700, color:'rgba(155,140,210,0.5)', letterSpacing:'3px', zIndex: 1 }}>
       TECH STACK
     </div>
...
```aura width=138 height=44 link="https://x.com/Diwakarjiii" inline align=center
<SocialMediaButton
...
```aura width=160 height=44 link="https://diwakar-bhagat.github.io/" inline align=center
<SocialMediaButton
...
```aura width=110 height=44 link="mailto:diwakarkumarbhagat7@gmail.com" inline align=center
<SocialMediaButton
